 ...
 *
 * All data is loaded asynchronously from Supabase.
...
import { Button, Card, StatusBadge, UrgencyBadge, EmptyState, Skeleton } from '@/components/ui';
...
export function FeedPage() {
  ...
  const STAT_CARDS = [
    ...
    { label: 'Your Deliveries', value: user ? userDeliveries : 0, color: 'text-orange-600 dark:text-orange-400', bg: 'bg-orange-50 dark:bg-orange-900/20' },
  ];
